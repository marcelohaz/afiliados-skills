...
```json
[
  { "resumo": "Custo-benefício é o tema mais recorrente. Preço competitivo para a quantidade. Comparação favorável com marcas importadas aparece em vários relatos.", "peso": 53 },
