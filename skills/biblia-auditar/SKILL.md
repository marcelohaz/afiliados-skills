...
- **Bivolt inferido errado** (FATO — wrong-info, canon 2026-06-28): campo curado afirma "bivolt"/"funciona em qualquer tomada"/"sem transformador" MAS o `specsAmazon`/`descricaoProduto` do ASIN traz voltagem ÚNICA (ex: "Voltagem 110 Volts") e o termo "bivolt" NÃO aparece no `specsAmazon`. Quase sempre nasce de o preenchedor ler copy de potência dual-SKU do fabricante (`"1800W 110V | 2000W 220V"`, `"110/127V e 220V"`) como aparelho bivolt — são SKUs separados, não bivolt. **Auto-fixável**: reescrever pra "vendido em versões 110V e 220V, confira no anúncio" ou omitir; nunca "bivolt". Lembre que **aparelho de aquecimento de alta potência é voltagem única por design** (air fryer, ferro, secador, chaleira). Exceção legítima (não flagar): impressora e cooktop a GÁS, onde bivolt é comum. Caso real: NA341/Midea/Mondial/WAP (air fryers) afirmados bivolt → propagou pra 4 sites (2026-06-28).
