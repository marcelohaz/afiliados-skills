...
Fix (quando NÃO for a exceção acima): adicionar/enxugar peer(s) no guia em spot **contextual** (FAQ/Marca/Vale a pena/Como escolher — **NÃO na Conclusão**, v1.24.0; navegação peer/home no fecho é decorativa), âncora = keyword singular do destino. Não bloqueia readyToLock (SEO interno, não defeito funcional).
